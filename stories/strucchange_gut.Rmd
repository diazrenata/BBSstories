...
Above, I set the minimum number of observations in a segment to 4. This is because setting it to 2 is too few (needs to be > regressors), and setting it to 3 gave Extremely Complex results:
